  ...
  render() {
    ...
    if (this.props.range === "week") {
      return <div className={"FNDTray "}>
        ...
        <Tray customers={this.props.customers} orders={this.props.orders}  addCrop={this.props.addCrop}  isBlocked={isBlocked} crops={this.props.crops} trayData={trays[4]} handleScheduleTDC={this.handleScheduleTDC} selectedCrop={this.props.selectedCrop} microgreens={this.props.microgreens} small={true}></Tray>
        <Tray customers={this.props.customers} orders={this.props.orders}  addCrop={this.props.addCrop}  isBlocked={isBlocked} crops={this.props.crops} trayData={trays[5]} handleScheduleTDC={this.handleScheduleTDC} selectedCrop={this.props.selectedCrop} microgreens={this.props.microgreens} small={true}></Tray>
      </div>;
    } else {
