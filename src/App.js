    ...
    if (isReady) {
      return <div className="App">
        ...
        <div id="board">
          ...
          {this.state.microgreens !== '' && this.state.tab === 5 ? <AddMicrogreens microgreens={this.state.microgreens} refreshMicrogreens={this.getMicrogreens} showMicrogreensTab={this.showMicrogreensTab}></AddMicrogreens> : null}
